...
const HomeLayout = ({ children, noSearch, handleSearch, search, handleAdditionalFilter }) => {
                ...
                <nav className="container mx-auto flex justify-between items-center">
                    ...
                    {!noSearch &&
                        <div class="relative">
                            ...
                            <input type="search"
                                // id="default-search"
                                class=" w-96 p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Search by Menu Items, Location, Restaurant Name..."
                                    onChange={(s) => { handleSearchHere(s) }}
                                    value={search}
                                required />
